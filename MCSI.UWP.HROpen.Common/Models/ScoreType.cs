...
namespace MCSI.UWP.HROpen.Common.Models
{
    ...
    public partial class ScoreType : BaseScoreType, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static ScoreType FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ScoreType>(data);
        }
