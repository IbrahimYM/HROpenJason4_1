...
{
    /// <summary>Common properties for communication items</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.9.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class CommunicationItem : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static CommunicationItem FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CommunicationItem>(data);
        }
